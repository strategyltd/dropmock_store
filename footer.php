...
<div class="dm_footer col-sm-12">
	...
	<div class="row" style="padding-left:15%;padding-right:15%;clear:both;">
		<div class="col-sm-4 footer-section">
			...
			<span><?= (get_theme_mod('contact_info_phone_1'))? get_theme_mod('contact_info_phone_1') : 'Phone 1' ;?></span>
			</br>
			<span><?= (get_theme_mod('contact_info_phone_2'))? get_theme_mod('contact_info_phone_2') : 'Phone 2' ;?></span>
		</div>
		<div class="col-sm-4 col-xs-6 footer-section borders">
		...
		<div class="col-sm-4 footer-section">
			...
			<span><?= (get_theme_mod('contact_info_address_1'))? get_theme_mod('contact_info_address_1') : 'Address Line 1' ;?></span>
			</br>
			<span><?= (get_theme_mod('contact_info_address_2'))? get_theme_mod('contact_info_address_2') : 'Address Line 2' ;?></span>
		</div>
	</div>
</div>
