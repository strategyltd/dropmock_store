...
define('DROPMOCK_MARKETPLACE_VERSION', '1.0');
...
function register_required_plugins() {
    ...
    array(
        ...
        'source' => DM_PARENT_DIRECTORY . '/plugins/wppusher.zip', // The plugin source.
...
function wp_bootstrap_starter_reminder(){
        $theme_page_url = 'https://afterimagedesigns.com/wp-bootstrap-starter/?dashboard=1';
            ...
            if(!get_option( 'triggered_welcomet')){
                $message = sprintf(__( 'Welcome to DropMock Store Theme! Before diving in to your new theme, Please make sure you have reviewed all tutorials needed to start selling on your store.', 'wp-bootstrap-starter' ),
...
add_action('customize_register', function ($wp_customize) {
    ...
    //CONTACT INFO
    $wp_customize->add_setting('contact_info_phone_1', array('' => 'refresh',));
    $wp_customize->add_setting('contact_info_phone_2', array('' => 'refresh',));
    $wp_customize->add_setting('contact_info_address_1', array('' => 'refresh',));
    $wp_customize->add_setting('contact_info_address_2', array('' => 'refresh',));
    $wp_customize->add_setting('contact_info_email', array('' => 'refresh',));
